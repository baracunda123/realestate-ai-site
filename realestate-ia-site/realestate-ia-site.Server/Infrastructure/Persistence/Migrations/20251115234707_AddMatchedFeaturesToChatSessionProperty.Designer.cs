...
namespace realestate_ia_site.Server.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251115234707_AddMatchedFeaturesToChatSessionProperty")]
    partial class AddMatchedFeaturesToChatSessionProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("realestate_ia_site.Server.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PermanentDeletionAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("permanent_deletion_at");
