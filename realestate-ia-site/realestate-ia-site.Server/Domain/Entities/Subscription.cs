...
namespace realestate_ia_site.Server.Domain.Entities
{
    ...
    public class Subscription
    {
        ...
        [Column("ended_at")] public long? EndedAt { get; set; }
        [Column("canceled_at")] public long? CanceledAt { get; set; }
        [Column("customer_cancellation_reason")] public string? CustomerCancellationReason { get; set; }
        [Column("customer_cancellation_comment")] public string? CustomerCancellationComment { get; set; }
        [Column("metadata", TypeName = "jsonb")] public JsonDocument? Metadata { get; set; }
        [Column("custom_field_data", TypeName = "jsonb")] public JsonDocument? CustomFieldData { get; set; }
        ...
        public BillingPeriod CurrentPeriod() => BillingPeriod.From(CurrentPeriodStart, CurrentPeriodEnd);
        public BillingPeriod LifetimePeriod() => BillingPeriod.From(StartedAt, EndsAt ?? EndedAt);
        public bool IsActive(DateTime? atUtc = null)
        {
