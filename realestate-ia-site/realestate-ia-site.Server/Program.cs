...
builder.Services.AddScoped<IPropertyFilter, TargetPriceFilter>();
builder.Services.AddScoped<IPropertyFilter, AreaFilter>();
builder.Services.AddScoped<IPropertyFilter, TargetAreaFilter>();
