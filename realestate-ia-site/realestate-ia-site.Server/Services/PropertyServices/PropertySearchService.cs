    ...
    public class PropertySearchService
    {
        ...
        public async Task<List<PropertySearchDto>> SearchPropertiesWithFiltersAsync(Dictionary<string, object> filtros)
        {
            ...
            if (filtros.ContainsKey("max_price") && filtros["max_price"] != null)
            {
                ...
                {
                    _logger.LogWarning("Valor inválido para 'max_price': {Value}", filtros["max_price"]);
                }
            }
            ...
            if (filtros.ContainsKey("rooms") && filtros["rooms"] != null)
            {
                ...
                {
                    _logger.LogWarning("Valor inválido para 'rooms': {Value}", filtros["rooms"]);
                }
            }
            ...
            try
            {
                _logger.LogDebug("Executando query na base de dados...");
                ...
                {
                    _logger.LogInformation("Nenhuma propriedade encontrada com os filtros aplicados");
                }
                else
                {
